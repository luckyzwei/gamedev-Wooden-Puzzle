...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] bool isApply = true;
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            if (StaticData.ENABLE_BANNER && UserData.Instance.CGameData.vip == 0)
            {

                offset = VKSdk.VKSafeArea.offset;
            }
            LastSafeArea = r;
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                // Debug.Log("r.position " + r.position.x +", " + r.position.y);
                 Debug.Log("r.size " + r.size.x +", " + r.size.y+","+offset);
                Vector2 anchorMin = r.position + offset;
